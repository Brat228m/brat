...
Объект исследования: работа магазина “Pril”.

Предмет исследования: информационная система, автоматизирующая работу продуктового магазина “Pril”.
...
При разработке информационной системы «Pril» было проведено обследование деятельности магазина по следующим источникам:
...
Проектирование информационной системы «Pril» начинается с этапа построения бизнес-процессов. Для описания бизнес-процессов в информационной системе «Pril», используется диаграмма прецедентов.
...
В ходе выполнения курсового проекта средствами MySQL Workbench была разработана информационная система «Pril», предназначенная для автоматизации работы директора магазина.
